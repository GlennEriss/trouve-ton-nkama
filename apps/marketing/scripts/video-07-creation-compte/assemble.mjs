/**
 * Video 07 - Montage final.
 *
 * Sortie:
 *   videos/video-07-creation-compte/final/video-07-creation-compte.mp4
 */
...
async function main() {
  console.log('Montage video-07-creation-compte');
  ...
  const parts = [
    await makeCard(browser, {
      ...
      subtitle: 'Avec Google ou avec votre email',
      duration: 4,
    }),
    capture,
    await makeCard(browser, {
