/**
 * Video 03 annonceur - Montage final.
 *
 ...
 *
 * Sortie:
 *   videos/video-03-annonceur/final/video-03-annonceur-complet.mp4
 */
...
async function main() {
  console.log('Montage video-03-annonceur');

  const access = path.join(FINAL, 'video-03-01-acces-plateforme.mp4');
  const create = path.join(FINAL, 'video-03-02-connexion-creation-annonce.mp4');
  const archive = path.join(FINAL, 'video-03-03-archiver-reactiver-annonce.mp4');
