/**
 * Video 08 - Montage final.
 *
 * Sortie:
 *   videos/video-08-creation-annonce-maison/final/video-08-creation-annonce-maison.mp4
 */
...
async function main() {
  console.log('Montage video-08-creation-annonce-maison');
  ...
  const parts = [
    await makeCard(browser, {
      id: '00-intro',
      badge: 'Maison à louer',
      title: 'Vous avez une maison à louer ?',
      subtitle: 'Publiez votre annonce sur Trouve Ton Nkama',
      duration: 6,
    }),
    capture,
    await makeCard(browser, {
      ...
      subtitle: 'Publiez vos annonces gratuitement',
      duration: 8,
    }),
  ];
  await browser.close();
