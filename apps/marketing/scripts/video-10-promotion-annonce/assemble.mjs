/**
 * Video 10 - Montage final.
 *
 * Sortie:
 *   videos/video-10-promotion-annonce/final/video-10-promotion-annonce.mp4
 */
...
async function main() {
  console.log('Montage video-10-promotion-annonce');
  ...
  const parts = [
    await makeCard(browser, {
      id: '00-intro',
      badge: 'Promotion',
      title: 'Rendez votre annonce plus visible',
      subtitle: 'À la une, tendance ou remontée en haut de liste',
      duration: 6,
    }),
    capture,
    await makeCard(browser, {
