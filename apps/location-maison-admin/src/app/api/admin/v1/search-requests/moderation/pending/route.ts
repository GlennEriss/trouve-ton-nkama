...
import { listPendingSearchRequests } from "@/modules/search-requests-moderation/application/search-requests-moderation.service";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await listPendingSearchRequests({
