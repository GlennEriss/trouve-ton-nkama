...
import { getAdsAnalyticsOverview } from "@/modules/analytics-insights/application/ads-analytics-read.service";
...
function mapServiceError(error: unknown) {
  ...
  return {
    ...
    message: error instanceof Error ? error.message : "Impossible de charger les analytics ads.",
  };
}
...
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await getAdsAnalyticsOverview({
