...
import { listAdsPlacements } from "@/modules/analytics-insights/application/ads-analytics-read.service";
...
function mapServiceError(error: unknown) {
  ...
  return {
    ...
    message:
      error instanceof Error ? error.message : "Impossible de charger la performance des emplacements.",
  };
}
...
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await listAdsPlacements({
