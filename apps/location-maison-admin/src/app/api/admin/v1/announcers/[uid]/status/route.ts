...
export async function PATCH(request: NextRequest, context: RouteContext) {
  ...
  let updated = null as Awaited<ReturnType<typeof updatePlatformUserStatus>> | null;
  try {
    ...
    return jsonError(
      {
        code: "INTERNAL_ERROR",
        message: "Impossible de modifier le statut annonceur.",
      },
      500,
      auth.correlationId,
    );
  ...
  await logAudit({
    ...
    action: "announcers.update_status",
    resource: "announcer",
    resourceId: uid,
    status: "success",
