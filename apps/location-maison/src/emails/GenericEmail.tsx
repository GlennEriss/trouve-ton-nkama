        ...
        <Row>
          <Column>
            ...
            <Text style={styleLinkText} className="mobile-text-small">
              https://tonnkama.com/reset?token=xyz789
            </Text>
          </Column>
        </Row>
      </Section>
      ...
      {process.env.NODE_ENV === 'development' && (
        <>
          ...
          <Section>
            <Row>
              <Column>
                <Text style={styleDebugInfo} className="mobile-text-small">
                  🔧 <strong>Mode Test - GenericEmail</strong>
                </Text>
                <Text style={styleDebugDetails} className="mobile-text-small">
                ...
                <Text style={styleDebugDetails} className="mobile-text-small">
                  Template: Email Générique (Structure PasswordReset)
                </Text>
                <Text style={styleDebugDetails} className="mobile-text-small">
                  Boutons: Liens vides pour test d'affichage
                </Text>
              </Column>
            </Row>
          </Section>
...
// Styles optimisés pour mobile (même structure que PasswordReset)
