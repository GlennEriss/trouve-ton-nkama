...
export default function PrivacyPolicyMobile() {
    return (
        <div className={cn('', inter.className)}>
            <div className='sticky top-0 border-t border px-5 py-10 bg-white'>
                <h1 className='text-2xl font-bold text-[#494949]'>Politique de confidentialité</h1>
                <span className='text-gray-500'>Dernière mise à jour le 28 avril 2025</span>
            </div>
            <div className='p-5 pb-28'>
                <h2 className="text-xl font-semibold text-[#494949] mt-4">Introduction</h2>
                ...
                <h2 className="text-xl font-semibold text-[#494949] mt-4">1. Données collectées</h2>
                ...
                <h2 className="text-xl font-semibold text-[#494949] mt-6">2. Utilisation des données</h2>
                <p className="text-gray-700 text-md leading-relaxed mt-2">
                ...
                <h2 className="text-xl font-semibold text-[#494949] mt-6">3. Partage des données</h2>
                <p className="text-gray-700 text-md leading-relaxed mt-2">
                ...
                <h2 className="text-xl font-semibold text-[#494949] mt-6">4. Sécurité des données</h2>
                <p className="text-gray-700 text-md leading-relaxed mt-2">
                    Nous mettons en place des mesures de sécurité avancées pour protéger vos données contre tout accès non autorisé.
                </p>

                <h2 className="text-xl font-semibold text-[#494949] mt-6">5. Vos droits</h2>
                <p className="text-gray-700 text-md leading-relaxed mt-2">
                ...
                <h2 className="text-xl font-semibold text-[#494949] mt-6">6. Contact</h2>
                <p className="text-gray-700 text-md leading-relaxed mt-2">
