    ...
    return (
        <div className={cn('', inter.className)}>
            <div className='sticky top-0 border-t border px-5 py-10 bg-white dark:bg-gray-900 dark:border-gray-700'>
                <h1 className='text-2xl font-bold text-gray-700 dark:text-white'>Suppression des Données</h1>
            ...
            <div className='p-5 pb-28'>
                ...
                <p className="mb-4 text-gray-700 dark:text-gray-300">
                    ...
                    <strong className='text-secondary'>{process.env.NEXT_PUBLIC_EMAIL_SUPPORT}</strong> en mentionnant l'objet « Suppression de compte ».
                </p>
                <p className="mb-4 text-gray-700 dark:text-gray-300">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                    ...
                    <Link href={routes.public.confidentiality} className="text-secondary underline">
