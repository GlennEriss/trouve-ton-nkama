  ...
  return (
    <div className={cn('p-4 md:p-20', inter.className)}>
      ...
      <section className='mt-8 md:mt-10'>
        <h1 className='text-2xl font-bold'>Bienvenue sur LogisGabon !</h1>
      ...
      <div className="flex items-center justify-center md:mt-10">
        <button className="w-full flex justify-center items-center gap-2 bg-white dark:bg-gray-900 border border-gray-300 rounded-full px-6 py-3 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
