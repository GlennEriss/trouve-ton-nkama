                    ...
                    <FormItem>
                        ...
                        >
                            <FormControl>
                                <SelectTrigger
                                    className={cn(
                                        'rounded-full transition-colors border-[#1FA89B] focus:ring-0 focus:border-[#1FA89B] focus:bg-[#ebf6f5] group py-6 text-md bg-gray-50 dark:bg-gray-900 dark:text-white'
                                    )}
                                >
