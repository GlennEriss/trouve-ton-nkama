    ...
    return (
        <div className={cn('', inter.className)}>
            <div className='sticky top-0 border-t border px-5 py-10 bg-white'>
                <h1 className='text-2xl font-bold text-[#494949]'>Conditions d&apos;Utilisation</h1>
                <span className='text-gray-500'>Dernière mise à jour le 28 avril 2025</span>
            </div>
            <div className='p-5 pb-28'>
                <section id="introduction" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-[#494949]">1. Introduction</h2>
                ...
                <section id="utilisation" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-[#494949]">2. Utilisation de la plateforme</h2>
                    <p className="text-gray-700">
                ...
                <section id="contenu" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-[#494949]">3. Contenu et responsabilité</h2>
                    <p className="text-gray-700">
                ...
                <section id="confidentialite" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-[#494949]">4. Confidentialité et protection des données</h2>
                    <p className="text-gray-700">
                ...
                <section id="modifications" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-[#494949]">5. Modifications des conditions</h2>
                    <p className="text-gray-700">
                ...
                <section id="contact" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-[#494949]">6. Contact</h2>
                    <p className="text-gray-700">
