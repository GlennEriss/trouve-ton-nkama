    ...
    return (
        <div className={cn('', inter.className)}>
            <div className='sticky top-0 border-t border px-5 py-10 bg-white dark:bg-gray-900 dark:border-gray-700'>
                <h1 className='text-2xl font-bold text-gray-700 dark:text-white'>Conditions d&apos;Utilisation</h1>
            ...
            <div className='p-5 pb-28'>
                <section id="introduction" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-gray-700 dark:text-white">1. Introduction</h2>
                    <p className="text-gray-700 dark:text-gray-300">
                        Bienvenue sur <strong className='text-secondary'>Trouve Ton Nkama</strong>. En accédant et en utilisant notre plateforme, vous acceptez nos conditions d&apos;utilisation.
                    </p>
                </section>

                <section id="utilisation" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-gray-700 dark:text-white">2. Utilisation de la plateforme</h2>
                    <p className="text-gray-700 dark:text-gray-300">
                ...
                <section id="contenu" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-gray-700 dark:text-white">3. Contenu et responsabilité</h2>
                    <p className="text-gray-700 dark:text-gray-300">
                ...
                <section id="confidentialite" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-gray-700 dark:text-white">4. Confidentialité et protection des données</h2>
                    <p className="text-gray-700 dark:text-gray-300">
                        La protection de vos données est notre priorité. Nous collectons et utilisons vos informations conformément à notre
                        <Link href={routes.public.confidentiality} className="text-secondary underline"> Politique de Confidentialité</Link>.
                    </p>
                </section>

                <section id="modifications" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-gray-700 dark:text-white">5. Modifications des conditions</h2>
                    <p className="text-gray-700 dark:text-gray-300">
                ...
                <section id="contact" className="mb-6">
                    <h2 className="text-xl font-semibold mb-2 text-gray-700 dark:text-white">6. Contact</h2>
                    <p className="text-gray-700 dark:text-gray-300">
                        Pour toute question relative à ces conditions, vous pouvez nous contacter à :
                        {" "}
                        <a href={`mailto:${process.env.NEXT_PUBLIC_EMAIL_SUPPORT}`} className="text-secondary hover:underline"> {process.env.NEXT_PUBLIC_EMAIL_SUPPORT}</a>.
                    </p>
                </section>
            </div>
        </div>
