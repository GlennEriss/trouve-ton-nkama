        ...
        <div className="container-page space-y-8">
          <section className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                href={searchHref}
                className="inline-flex items-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-white hover:bg-primary-800 transition-colors"
              >
              ...
              {cityLabel ? (
                <Link
                  ...
                  className="inline-flex items-center rounded-full border border-primary px-5 py-2.5 text-sm font-semibold text-primary hover:bg-primary hover:text-white transition-colors"
                >
                  Voir tout le Gabon
                </Link>
              ) : null}
          ...
          <section className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
            ...
            {hasMoreResults ? (
              <div className="mt-6 flex justify-center">
                <Link
                  href={searchHref}
                  className="inline-flex items-center rounded-full border border-primary px-6 py-2.5 text-sm font-semibold text-primary hover:bg-primary hover:text-white transition-colors"
                >
          ...
          <section className="rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
            <h2 className="text-xl font-semibold text-primary">Explorer par ville</h2>
            <div className="mt-4 flex flex-wrap gap-3">
              {cityLandingLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="rounded-full border border-gray-200 bg-white px-4 py-2 text-sm text-gray-700 hover:border-primary hover:text-primary transition-colors"
                >
                  {link.label}
                </Link>
              ))}
