...
export default function page() {
    return (
        <div className='space-y-4 mb-20 dark:bg-gray-900 min-h-screen'>
            {/* En-tête */}
            <div className='sticky top-0 md:static z-50 bg-white dark:bg-gray-800 px-5 py-3 md:pt-4 pb-4 shadow border-b dark:border-gray-700 flex items-center justify-between'>
