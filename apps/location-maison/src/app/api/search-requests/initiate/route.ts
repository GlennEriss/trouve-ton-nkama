...
export async function POST(request: NextRequest) {
  try {
    ...
    const cloudFunctionUrl = isLocalEnvironment
      ? `http://127.0.0.1:5001/${process.env.FIREBASE_PROJECT_ID}/us-central1/initiateSearchRequestPayment`
      : `https://us-central1-${process.env.FIREBASE_PROJECT_ID}.cloudfunctions.net/initiateSearchRequestPayment`;
