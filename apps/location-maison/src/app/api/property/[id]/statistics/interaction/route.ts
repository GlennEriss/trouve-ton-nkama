...
export async function POST(
  ...
  try {
    ...
    const success = await trackPropertyInteraction(id, type as InteractionType, {
      ...metadata,
    ...
    return NextResponse.json({ success: true, message: 'Interaction tracked successfully' }, { status: 200 });
  } catch (error) {
