...
- Name: lot5b-forms-auth-balance.spec.ts >> Lot 5B mobile dark >> recharge-solde reste utilisable
...
Error: Violations WCAG bloquantes: [
  ...
  },
  {
    ...
    "targets": [
      ...
      ".py-2\\.5",
      ".border-2.text-left.opacity-100:nth-child(1) > .space-y-6.text-center > .px-6.w-full.text-white",
      ".border-secondary > .space-y-6.text-center > .px-6.w-full.text-white",
      ".border-2.text-left.opacity-100:nth-child(3) > .space-y-6.text-center > .px-6.w-full.text-white",
      ".border-gradient-to-r > .space-y-6.text-center > .px-6.w-full.text-white"
    ],
    "elements": [
