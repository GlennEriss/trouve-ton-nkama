...
- Name: lot5b-forms-auth-balance.spec.ts >> Lot 5B mobile dark >> connexion reste utilisable
...
Error: Violations WCAG bloquantes: [
  {
    ...
    "elements": [
      "<span class=\"px-4 py-1 text-primary bg-primary-50 rounded-full text-sm font-medium\">OU</span>"
    ]
  }
]
    ...
    - main [ref=e3]:
      - generic [ref=e4]:
        - link "Retour à l'accueil" [ref=e6] [cursor=pointer]:
          ...
          - img [ref=e7]
        - generic [ref=e9]:
          - heading "Bienvenue sur Trouve Ton Nkama !" [level=1] [ref=e10]
          - paragraph [ref=e11]: Connectez-vous pour retrouver vos annonces, favoris et paramètres de compte.
        - generic [ref=e13]:
          - generic [ref=e14]:
            - text: Email
            - generic [ref=e15]:
        ...
        - generic [ref=e36]: OU
        - button "Continuer avec Google" [ref=e39] [cursor=pointer]:
          - img
          - generic [ref=e40]: Continuer avec Google
        - button "Continuer avec Numéro de téléphone" [ref=e42] [cursor=pointer]:
          - img
          - generic [ref=e43]: Continuer avec Numéro de téléphone
        - paragraph [ref=e45]:
          - text: Vous n'avez pas de compte?
          - link "S'enregistrer" [ref=e46] [cursor=pointer]:
            - /url: /signup
