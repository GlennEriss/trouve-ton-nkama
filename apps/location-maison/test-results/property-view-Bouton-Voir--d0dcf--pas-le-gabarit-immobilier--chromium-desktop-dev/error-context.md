...
- Name: property-view.spec.ts >> Bouton "Voir" /property — immobilier et Mode >> Voir une annonce Mode ouvre la fiche Mode correcte (pas le gabarit immobilier)
- Location: __tests__/e2e/property-view.spec.ts:95:7
...
Locator: getByText('Robe test bouton Voir E2E')
Expected: visible
Error: strict mode violation: getByText('Robe test bouton Voir E2E') resolved to 2 elements:
    1) <h3 class="line-clamp-2 min-h-[3rem] text-lg font-semibold text-gray-900 dark:text-white">Robe test bouton Voir E2E</h3> aka getByRole('heading', { name: 'Robe test bouton Voir E2E' }).first()
    2) <h3 class="line-clamp-2 min-h-[3rem] text-lg font-semibold text-gray-900 dark:text-white">Robe test bouton Voir E2E</h3> aka getByRole('heading', { name: 'Robe test bouton Voir E2E' }).nth(1)

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText('Robe test bouton Voir E2E')
