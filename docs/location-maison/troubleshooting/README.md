...
- **BUGS-PROPERTY-E2E-2026-08.md** : Bugs trouvés et corrigés via les tests e2e réels de /property — z-index Select sous Dialog/Sheet, promotion jamais affichée côté client, suppression d'annonce bloquée 30-60s puis en échec pour la quasi-totalité des utilisateurs
